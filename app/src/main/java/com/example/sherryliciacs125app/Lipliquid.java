...
public class Lipliquid extends AppCompatActivity {
    ...
    private static final String TAG = "Lipliquid";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d(TAG, "onCreate: Lipliquid Started.");
        ...
        Button returnlipliquid = findViewById(R.id.returnlipliquid);
    ...
    private void getData() {
        ...
        url = "http://makeup-api.herokuapp.com/api/v1/products.json?product_category=liquid&product_type=lipstick";
